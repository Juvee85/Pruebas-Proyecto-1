...
public class EvaluadorContrasenasTest {
    ...
    public void testVerificarSeguridad_BAJO() {
        System.out.println("[*] Verificar Contrasena de Baja Seguridad");
    ...
    public void testVerificarSeguridad_MEDIO() {
        System.out.println("[*] Verificar Contrasena de Seguridad Media");
    ...
    public void testVerificarSeguridad_ALTO() {
        System.out.println("[*] Verificar Contrasena de Alta Seguridad");
